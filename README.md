...
Requirements: a Hugging Face token stored in Colab Secrets as `HF_TOKEN`, with the model licence accepted at [bodhan-ai/indic-transcribe-flex](https://huggingface.co/bodhan-ai/indic-transcribe-flex), and a mounted Google Drive for artifacts.
